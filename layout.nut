...
//adjust the values below for the static preview video snap
   ...
   local snapbg=null;
   snapbg = fe.add_image( "static.mp4", flx*0.048, fly*0.183, flw*0.513, flh*0.5245 );
 ...
 {
 local temp = fe.add_text("", flx*0.048, fly*0.183, flw*0.513, flh*0.5245 );
...
surface_snap.set_pos(flx*0.048, fly*0.183, flw*0.513, flh*0.5245);
...
// Load wheel image
local w_art = fe.add_image("backgrounds/default.png", flx*0, fly*0, flw*1, flh*1 );
w_art.alpha=255;
...
//Title text info
local textt = fe.add_text( "[Title]", flx*0.0435, fly*0.899, flw*0.6, flh*0.056  );
textt.set_rgb( 0, 0, 0 );
...
local textgc = fe.add_text( "Game Count: [ListEntry]-[ListSize]", flx*2.21, fly*0.932, flw*0.4, flh*0.05  );
...
//Year text info
local texty = fe.add_text("Year: [Year]", flx*2.21, fly*0.875, flw*0.2, flh*0.05 );
texty.set_rgb( 0, 0, 0 );
...
local glogo1 = fe.add_image("glogos/unknown1.png", flx*2.08, fly*0.82, flw*0.11, flh*0.17);
